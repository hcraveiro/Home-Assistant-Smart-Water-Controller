...
class SmartWaterControllerNumberEntity(SmartWaterControllerBaseEntity, NumberEntity):
    def __init__(
...
class IrrigationManualDuration(SmartWaterControllerNumberEntity):
    def __init__(self, coordinator: SmartWaterControllerCoordinator, device: dict[str, Any], parameter: str):
        super().__init__(coordinator, device, parameter)
...
class IrrigationFlowRate(SmartWaterControllerNumberEntity):
    def __init__(self, coordinator: SmartWaterControllerCoordinator, device: dict[str, Any], parameter: str):
        super().__init__(coordinator, device, parameter)
        self._attr_min_value = 1
